...
class MultimodalMetadata:
    ...
    keyframe_id: str
    video_id: str              # Them de Phase 3/4 group theo video, khong parse keyframe_id
...
class RetrievalResult:
    ...
    video_id: str
    frame_ids: List[int]       # N phan tu neu la TRAKE, 1 phan tu neu KIS/Q&A
    query_type: str            # "KIS", "Q&A", hoac "TRAKE" -- Phase 5 dung de format CSV
    answer: Optional[str]      # Chi dung cho Q&A
    wrrf_score: float
