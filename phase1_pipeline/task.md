...
Trách nhiệm cốt lõi (Core Responsibility)
...
Đầu vào (Input): Các tệp video thô nguyên bản định dạng .mp4 được cung cấp từ bộ dữ liệu.

Đầu ra (Output): Danh sách đối tượng KeyframeData chuẩn hóa:
[
{
